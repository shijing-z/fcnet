...
for extracting network indices from the loaded matrices.
[`ex_conn_array`](https://shijing-z.github.io/fcnet/reference/ex_conn_array.md)
for example data included in the package.
