...
![Example 1](reference/figures/example1.png)*AHIP/PHIP connectivity to 7
networks by age group, generated based on `plot_compare` outputs*

![Example 2](reference/figures/example2.png)*Hippocampal-Network
connectivity vs. memory performance by age group, generated based on
`plot_scatter` outputs*
